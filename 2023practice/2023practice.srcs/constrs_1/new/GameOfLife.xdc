...
# VGA Output - Bank 33
# ---------------------------------------------------------------------------- 
set_property -dict { PACKAGE_PIN Y21  IOSTANDARD LVCMOS33 } [get_ports {o_blue[0]}];  # "VGA-B1"
set_property -dict { PACKAGE_PIN Y20  IOSTANDARD LVCMOS33 } [get_ports {o_blue[1]}];  # "VGA-B2"
set_property -dict { PACKAGE_PIN AB20 IOSTANDARD LVCMOS33 } [get_ports {o_blue[2]}];  # "VGA-B3"
set_property -dict { PACKAGE_PIN AB19 IOSTANDARD LVCMOS33 } [get_ports {o_blue[3]}];  # "VGA-B4"
set_property -dict { PACKAGE_PIN AB22 IOSTANDARD LVCMOS33 } [get_ports {o_green[0]}];  # "VGA-G1"
set_property -dict { PACKAGE_PIN AA22 IOSTANDARD LVCMOS33 } [get_ports {o_green[1]}];  # "VGA-G2"
set_property -dict { PACKAGE_PIN AB21 IOSTANDARD LVCMOS33 } [get_ports {o_green[2]}];  # "VGA-G3"
set_property -dict { PACKAGE_PIN AA21 IOSTANDARD LVCMOS33 } [get_ports {o_green[3]}];  # "VGA-G4"
set_property -dict { PACKAGE_PIN V20  IOSTANDARD LVCMOS33 } [get_ports {o_red[0]}];  # "VGA-R1"
set_property -dict { PACKAGE_PIN U20  IOSTANDARD LVCMOS33 } [get_ports {o_red[1]}];  # "VGA-R2"
set_property -dict { PACKAGE_PIN V19  IOSTANDARD LVCMOS33 } [get_ports {o_red[2]}];  # "VGA-R3"
set_property -dict { PACKAGE_PIN V18  IOSTANDARD LVCMOS33 } [get_ports {o_red[3]}];  # "VGA-R4"
set_property -dict { PACKAGE_PIN AA19 IOSTANDARD LVCMOS33 } [get_ports {o_hsync}];  # "VGA-HS"
set_property -dict { PACKAGE_PIN Y19  IOSTANDARD LVCMOS33 } [get_ports {o_vsync}];  # "VGA-VS"
