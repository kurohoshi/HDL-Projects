...
# VGA Output - Bank 33
# ---------------------------------------------------------------------------- 
set_property -dict { PACKAGE_PIN Y21  IOSTANDARD LVCMOS33 } [get_ports {o_vga_blue[0]}];  # "VGA-B1"
set_property -dict { PACKAGE_PIN Y20  IOSTANDARD LVCMOS33 } [get_ports {o_vga_blue[1]}];  # "VGA-B2"
set_property -dict { PACKAGE_PIN AB20 IOSTANDARD LVCMOS33 } [get_ports {o_vga_blue[2]}];  # "VGA-B3"
set_property -dict { PACKAGE_PIN AB19 IOSTANDARD LVCMOS33 } [get_ports {o_vga_blue[3]}];  # "VGA-B4"
set_property -dict { PACKAGE_PIN AB22 IOSTANDARD LVCMOS33 } [get_ports {o_vga_green[0]}];  # "VGA-G1"
set_property -dict { PACKAGE_PIN AA22 IOSTANDARD LVCMOS33 } [get_ports {o_vga_green[1]}];  # "VGA-G2"
set_property -dict { PACKAGE_PIN AB21 IOSTANDARD LVCMOS33 } [get_ports {o_vga_green[2]}];  # "VGA-G3"
set_property -dict { PACKAGE_PIN AA21 IOSTANDARD LVCMOS33 } [get_ports {o_vga_green[3]}];  # "VGA-G4"
set_property -dict { PACKAGE_PIN V20  IOSTANDARD LVCMOS33 } [get_ports {o_vga_red[0]}];  # "VGA-R1"
set_property -dict { PACKAGE_PIN U20  IOSTANDARD LVCMOS33 } [get_ports {o_vga_red[1]}];  # "VGA-R2"
set_property -dict { PACKAGE_PIN V19  IOSTANDARD LVCMOS33 } [get_ports {o_vga_red[2]}];  # "VGA-R3"
set_property -dict { PACKAGE_PIN V18  IOSTANDARD LVCMOS33 } [get_ports {o_vga_red[3]}];  # "VGA-R4"
set_property -dict { PACKAGE_PIN AA19 IOSTANDARD LVCMOS33 } [get_ports {o_vga_hsync}];  # "VGA-HS"
set_property -dict { PACKAGE_PIN Y19  IOSTANDARD LVCMOS33 } [get_ports {o_vga_vsync}];  # "VGA-VS"
...
# ---------------------------------------------------------------------------- 
set_property -dict { PACKAGE_PIN F22   IOSTANDARD LVCMOS25 } [get_ports {i_switch0}];  # "SW0"
set_property -dict { PACKAGE_PIN G22   IOSTANDARD LVCMOS25 } [get_ports {i_switch1}];  # "SW1"
set_property -dict { PACKAGE_PIN H22   IOSTANDARD LVCMOS25 } [get_ports {i_switch2}];  # "SW2"
#set_property PACKAGE_PIN F21 [get_ports {SW3}];  # "SW3"
#set_property PACKAGE_PIN H19 [get_ports {SW4}];  # "SW4"
#set_property PACKAGE_PIN H18 [get_ports {SW5}];  # "SW5"
#set_property PACKAGE_PIN H17 [get_ports {SW6}];  # "SW6"
set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS25 } [get_ports {i_reset}];  # "SW7"
