...
# ---------------------------------------------------------------------------- 
set_property -dict { PACKAGE_PIN Y9 IOSTANDARD LVCMOS33 } [get_ports {i_clk}];  # "GCLK"
create_clock -name sys_clk -period 10 -waveform {0 5} -add [get_ports i_clk] 
...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property -dict { PACKAGE_PIN T22 IOSTANDARD LVCMOS33 } [get_ports {o_rx_data[0]}];  # "LD0"
set_property -dict { PACKAGE_PIN T21 IOSTANDARD LVCMOS33 } [get_ports {o_rx_data[1]}];  # "LD1"
set_property -dict { PACKAGE_PIN U22 IOSTANDARD LVCMOS33 } [get_ports {o_rx_data[2]}];  # "LD2"
set_property -dict { PACKAGE_PIN U21 IOSTANDARD LVCMOS33 } [get_ports {o_rx_data[3]}];  # "LD3"
set_property -dict { PACKAGE_PIN V22 IOSTANDARD LVCMOS33 } [get_ports {o_rx_data[4]}];  # "LD4"
set_property -dict { PACKAGE_PIN W22 IOSTANDARD LVCMOS33 } [get_ports {o_rx_data[5]}];  # "LD5"
set_property -dict { PACKAGE_PIN U19 IOSTANDARD LVCMOS33 } [get_ports {o_rx_data[6]}];  # "LD6"
set_property -dict { PACKAGE_PIN U14 IOSTANDARD LVCMOS33 } [get_ports {o_rx_data[7]}];  # "LD7"

# ----------------------------------------------------------------------------
# VGA Output - Bank 33
# ---------------------------------------------------------------------------- 
#set_property -dict { PACKAGE_PIN Y21  IOSTANDARD LVCMOS33 } [get_ports {VGA-B1}];  # "VGA-B1"
#set_property -dict { PACKAGE_PIN Y20  IOSTANDARD LVCMOS33 } [get_ports {VGA-B2}];  # "VGA-B2"
#set_property -dict { PACKAGE_PIN AB20 IOSTANDARD LVCMOS33 } [get_ports {VGA-B3}];  # "VGA-B3"
#set_property -dict { PACKAGE_PIN AB19 IOSTANDARD LVCMOS33 } [get_ports {VGA-B4}];  # "VGA-B4"
#set_property -dict { PACKAGE_PIN AB22 IOSTANDARD LVCMOS33 } [get_ports {VGA-G1}];  # "VGA-G1"
#set_property -dict { PACKAGE_PIN AA22 IOSTANDARD LVCMOS33 } [get_ports {VGA-G2}];  # "VGA-G2"
#set_property -dict { PACKAGE_PIN AB21 IOSTANDARD LVCMOS33 } [get_ports {VGA-G3}];  # "VGA-G3"
#set_property -dict { PACKAGE_PIN AA21 IOSTANDARD LVCMOS33 } [get_ports {VGA-G4}];  # "VGA-G4"
#set_property -dict { PACKAGE_PIN V20  IOSTANDARD LVCMOS33 } [get_ports {VGA-R1}];  # "VGA-R1"
#set_property -dict { PACKAGE_PIN U20  IOSTANDARD LVCMOS33 } [get_ports {VGA-R2}];  # "VGA-R2"
#set_property -dict { PACKAGE_PIN V19  IOSTANDARD LVCMOS33 } [get_ports {VGA-R3}];  # "VGA-R3"
#set_property -dict { PACKAGE_PIN V18  IOSTANDARD LVCMOS33 } [get_ports {VGA-R4}];  # "VGA-R4"
#set_property -dict { PACKAGE_PIN AA19 IOSTANDARD LVCMOS33 } [get_ports {VGA-HS}];  # "VGA-HS"
#set_property -dict { PACKAGE_PIN Y19  IOSTANDARD LVCMOS33 } [get_ports {VGA-VS}];  # "VGA-VS"
...
# ---------------------------------------------------------------------------- 
#set_property -dict { PACKAGE_PIN F22 IOSTANDARD LVCMOS33 } [get_ports {i_tx_data[0]}];  # "SW0"
#set_property -dict { PACKAGE_PIN G22 IOSTANDARD LVCMOS33 } [get_ports {i_tx_data[1]}];  # "SW1"
#set_property -dict { PACKAGE_PIN H22 IOSTANDARD LVCMOS33 } [get_ports {i_tx_data[2]}];  # "SW2"
#set_property -dict { PACKAGE_PIN F21 IOSTANDARD LVCMOS33 } [get_ports {i_tx_data[3]}];  # "SW3"
#set_property -dict { PACKAGE_PIN H19 IOSTANDARD LVCMOS33 } [get_ports {i_tx_data[4]}];  # "SW4"
#set_property -dict { PACKAGE_PIN H18 IOSTANDARD LVCMOS33 } [get_ports {i_tx_data[5]}];  # "SW5"
#set_property -dict { PACKAGE_PIN H17 IOSTANDARD LVCMOS33 } [get_ports {i_tx_data[6]}];  # "SW6"
#set_property -dict { PACKAGE_PIN M15 IOSTANDARD LVCMOS33 } [get_ports {i_tx_data[7]}];  # "SW7"
