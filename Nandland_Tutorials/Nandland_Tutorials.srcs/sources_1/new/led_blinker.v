...
module led_blinker #(
  ...
  localparam CLK_1 = ( FREQ / ( 1 * 2 * SCALER ) );
  localparam CLK_2 = ( FREQ / ( 10 * 2 * SCALER ) );
  localparam CLK_3 = ( FREQ / ( 50 * 2 * SCALER ) );
  localparam CLK_4 = ( FREQ / ( 100 * 2 * SCALER ) );
  ...
  assign driver_led = switch_1 && enable
